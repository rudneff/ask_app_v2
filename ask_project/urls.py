...
urlpatterns = [
    ...
    url(r'^question-delete/$', QuestionDeleteView.as_view(), name='question-delete-page'),
    ...
    url(r'^answer-delete/$', AnswerDeleteView.as_view(), name='answer-delete-page'),
    ...
    url(r'^user-delete/$', UserDeleteView.as_view(), name='user-delete-page'),
